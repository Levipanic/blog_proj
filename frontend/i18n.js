(function initI18n() {
  ...
  const TRANSLATIONS = {
    ru: {
      ...
      "settings.theme": "Тема",
      "settings.smoothScroll": "Плавная прокрутка",
      "settings.on": "Вкл",
      "settings.off": "Выкл",
      "settings.feedView": "Вид ленты",
      "settings.feedList": "Лента",
      "settings.feedGrid": "Плитки",
      "settings.reset": "Очистить мои настройки и прогресс",
      "settings.resetDone": "Настройки и прогресс очищены.",
      ...
      "feed.statusNew": "новое!",
      "feed.statusStarted": "начато ({percent}%)",
      "feed.statusRead": "прочитано",
      "feed.readingTime": "~{minutes} мин чтения",
      ...
      "post.commentPending": "Комментарий принят и появится после проверки.",
      "post.commentChallengeError": "Не удалось подготовить форму комментария. Обновите страницу и попробуйте снова.",
      ...
      "post.toc": "Оглавление",
      "post.continueReading": "Продолжить чтение",
      "post.continueAt": "Продолжить с {percent}%",
      "admin.title": "Админка",
      ...
      "admin.sectionNavAria": "Разделы админки",
      "admin.navCreate": "Создание поста",
      "admin.navAntispam": "Антиспам",
      "admin.sectionAntispam": "3) Антиспам",
      "admin.antispamRefresh": "Обновить антиспам",
      "admin.antispamLoading": "Загрузка антиспама...",
      "admin.antispamLoaded": "Данные антиспама загружены.",
      "admin.antispamLoadFailed": "Не удалось загрузить антиспам.",
      "admin.antispamActionFailed": "Не удалось выполнить действие.",
      "admin.antispamPending": "На проверке",
      "admin.antispamNoPending": "Комментариев на проверке нет.",
      "admin.antispamMutes": "Активные mute",
      "admin.antispamNoMutes": "Активных mute нет.",
      "admin.antispamAttempts": "Последние попытки",
      "admin.antispamNoAttempts": "Попыток комментариев пока нет.",
      "admin.antispamEmpty": "Здесь пока пусто.",
      "admin.antispamApprove": "Одобрить",
      "admin.antispamReject": "Отклонить",
      "admin.antispamUnmute": "Снять mute",
      ...
      "admin.draftRestored": "Черновик восстановлен.",
      ...
      "admin.editPost": "Редактировать",
      "admin.savingEdit": "Сохранение...",
      "admin.editTitle": "Редактировать пост",
      "admin.cancelEdit": "Отменить редактирование",
      "admin.postUpdated": "Пост обновлён.",
      "admin.postLoadFailed": "Не удалось загрузить пост.",
      "admin.coverSection": "Обложка поста",
      "admin.coverAuto": "Авто",
      "admin.coverFromBlocks": "Выбрать из блоков",
      "admin.coverUpload": "Загрузить как обложку",
      "admin.coverSelectBlock": "Выберите медиа-блок для обложки",
      "admin.coverNoMediaBlocks": "Нет медиа-блоков в посте",
      "admin.coverSetAsCover": "Сделать обложкой",
      "admin.coverRemove": "Убрать обложку",
      "admin.coverUploadBtn": "Загрузить файл обложки",
      "admin.coverSelected": "Обложка выбрана",
      "admin.spoiler": "Это спойлер",
      "post.spoilerReveal": "Спойлер — нажмите, чтобы показать",
      ...
      "admin.dragBlock": "Перетащить блок",
      ...
      "errors.commentSoftLimit": "Слишком много сообщений подряд. Попробуй чуть позже.",
    ...
    en: {
      ...
      "settings.on": "On",
      "settings.off": "Off",
      "settings.feedView": "Feed view",
      "settings.feedList": "Feed",
      "settings.feedGrid": "Tiles",
      "settings.reset": "Clear my settings and progress",
      "settings.resetDone": "Settings and progress cleared.",
      ...
      "feed.statusNew": "new!",
      "feed.statusStarted": "started ({percent}%)",
      "feed.statusRead": "read",
      "feed.readingTime": "~{minutes} min read",
      ...
      "post.commentPending": "Comment received and will appear after review.",
      "post.commentChallengeError": "Could not prepare the comment form. Refresh and try again.",
      ...
      "post.continueAt": "Continue from {percent}%",
      "admin.title": "Admin",
      ...
      "admin.sectionNavAria": "Admin sections",
      "admin.navCreate": "Create Post",
      "admin.navAntispam": "Antispam",
      "admin.sectionAntispam": "3) Antispam",
      "admin.antispamRefresh": "Refresh antispam",
      "admin.antispamLoading": "Loading antispam data...",
      "admin.antispamLoaded": "Antispam data loaded.",
      "admin.antispamLoadFailed": "Could not load antispam data.",
      "admin.antispamActionFailed": "Action failed.",
      "admin.antispamPending": "Pending comments",
      "admin.antispamNoPending": "No pending comments.",
      "admin.antispamMutes": "Active mutes",
      "admin.antispamNoMutes": "No active mutes.",
      "admin.antispamAttempts": "Recent attempts",
      "admin.antispamNoAttempts": "No comment attempts yet.",
      "admin.antispamEmpty": "Nothing here.",
      "admin.antispamApprove": "Approve",
      "admin.antispamReject": "Reject",
      "admin.antispamUnmute": "Unmute",
      ...
      "admin.draftRestored": "Draft restored.",
      ...
      "admin.editPost": "Edit",
      "admin.savingEdit": "Saving...",
      "admin.editTitle": "Edit post",
      "admin.cancelEdit": "Cancel editing",
      "admin.postUpdated": "Post updated.",
      "admin.postLoadFailed": "Could not load post.",
      "admin.coverSection": "Post cover",
      "admin.coverAuto": "Auto",
      "admin.coverFromBlocks": "From post blocks",
      "admin.coverUpload": "Upload as cover",
      "admin.coverSelectBlock": "Select a media block for the cover",
      "admin.coverNoMediaBlocks": "No media blocks in the post",
      "admin.coverSetAsCover": "Set as cover",
      "admin.coverRemove": "Remove cover",
      "admin.coverUploadBtn": "Upload cover file",
      "admin.coverSelected": "Cover selected",
      "admin.spoiler": "Mark as spoiler",
      "post.spoilerReveal": "Spoiler — click to reveal",
      ...
      "errors.commentSoftLimit": "Too many messages in a row. Please try a bit later.",
  ...
  function translateError(rawMessage) {
    ...
    if (message === "Too many messages in a row. Please try a bit later.") {
      return t("errors.commentSoftLimit");
    }
